...
include ('header.php');
 ...
 if(isset($_POST["ime"])){
					 ...
					 //unosenje podataka u bazu
                          $forma = "INSERT INTO `takmicari`(`ime`, `prezime`, `brojCipa`, `idKategorije`, `registracioniBroj`) VALUES ('".$_POST["ime"]."', '".$_POST["prezime"]."', '".$_POST["brojCipa"]."', '".$_POST["idKategorije"]."', '".$_POST["registracioniBroj"]."')";  
